...
import { Play, Pause, Volume2, VolumeX, Music, Radio, Upload, Cloud } from 'lucide-react';
...
export function AudioPlayer({ audio }: AudioPlayerProps) {
  ...
  const getArtwork = () => {
    ...
    if ((audio.source === 'local' || audio.source === 'remote') && coverImageUrl) {
          ...
          <div className="flex-1 space-y-4">
            ...
            <div>
              <div className="flex items-center gap-2">
                ...
                <Badge variant={audio.source === 'audius' ? 'outline' : audio.source === 'remote' ? 'outline' : 'secondary'}>
                  {getSourceIcon()}
