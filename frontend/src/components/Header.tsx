...
import { Menu, Info, Settings, Disc3 } from 'lucide-react';
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
...
const SSCC_FALLBACK: AlbumView = {
  ...
  theme: '',
  trackIds: [],
  listenerTier: { name: '', description: '', supply: BigInt(0), price: BigInt(0) },
  collectorTier: { name: '', description: '', supply: BigInt(0), price: BigInt(0) },
  investorTier: { name: '', description: '', supply: BigInt(0), price: BigInt(0) },
