...
export function CanisterInfoModal({ open, onOpenChange }: CanisterInfoModalProps) {
  ...
  const getCanisterId = (): string => {
    try {
      ...
      if (typeof window !== 'undefined') {
        ...
        const canisterId = (window as any).BACKEND_CANISTER_ID || 
      ...
      if (hostname.includes('.localhost') || hostname.includes('.ic0.app') || hostname.includes('.raw.ic0.app')) {
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center gap-2">
              ...
              <Button
                ...
                disabled={!isAuthenticated || principalId === 'Not available' || principalId === 'Error loading ID'}
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center gap-2">
              ...
              <Button
                ...
                disabled={canisterId === 'Not available' || canisterId === 'Error loading ID'}
