...
function hashDomTreeString(input: string): string {
  ...
  // biome-ignore lint/style/useTemplate: concatenation is intentional here
...
function clearBadges(): void {
  ...
  // biome-ignore lint/complexity/noForEach: NodeList forEach is standard DOM API
...
export class EditCommunicator {
  ...
  #generateDOMTreeString(element: HTMLElement): string {
    ...
    const buildTree = (
      ...
      // biome-ignore lint/complexity/noForEach: array forEach is appropriate here
